    ...
    try {
      ...
      if (!doc.getElementById("cusdis-quartz-overrides")) {
        ...
        style.textContent = [
          ...
          '  line-height: 1.5 !important;',
          '  border-radius: 8px !important;',
          '  border: 1px solid rgba(40, 75, 99, 0.24) !important;',
          '  background: rgba(40, 75, 99, 0.08) !important;',
          '  color: #284b63 !important;',
          ...
          '}',
          '.dark [role="alert"],',
          '.dark div[class*="bg-blue-"] {',
          '  border-color: rgba(123, 151, 170, 0.35) !important;',
          '  background: rgba(123, 151, 170, 0.12) !important;',
          '  color: #d4d4d4 !important;',
          '}',
          '.dark a,',
          '.dark .text-gray-500,',
